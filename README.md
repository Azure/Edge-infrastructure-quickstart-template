...
* [Azure Arc VM](https://learn.microsoft.com/en-us/azure-stack/hci/manage/azure-arc-vm-management-overview)
...
## Scenario 2: Export a custom template from sample infrastructure settings, then scale
