...
if [[ $OSTYPE == *"linux"* ]]; then
    if [[ $arch == *"arm"* ]]; then
        wget "https://aka.ms/az-edge-module-export-linux-arm64" -O az-edge-module-export
    ...
    if [[ $arch == *"arm"* ]]; then
        wget "https://aka.ms/az-edge-module-export-darwin-arm64" -O az-edge-module-export
